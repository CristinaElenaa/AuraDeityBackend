...
namespace Logic.Commands
{
    ...
    {
        AuraDeityContext _auraDeityContext;
        IJwtQueryService _jwtQueryService;



        public AuthenticationCommand(AuraDeityContext auraDeityContext, IJwtQueryService jwtQueryService )
        {
